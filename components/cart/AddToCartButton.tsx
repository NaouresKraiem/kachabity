    ...
    if (variant === "small") {
        return (
            ...
            >
                ...
                {justAdded ? text.added : isAdding ? text.adding : text.addToCart}
            </button>
        );
    }
